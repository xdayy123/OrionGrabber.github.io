...
async function Buy() {
        var discordInvite = "https://discord.gg/oriongrabber"
        Swal.fire({
                title: `<h4>Buy Orion</h4>`,
                imageUrl: 'assets/images/favicon/orion.ico',
                imageWidth: 100,
                imageHeight: 100,
                width: 425,
                customClass: {
                ...
                background: '#292929',
                html:
                        `<p style="font-size: 14px"><b>Orion69#0001</b> Is The Owner Of Orion And He Will Sell It To You When You Join The Discord</p>`,
                showDenyButton: true,
                focusConfirm: true,
